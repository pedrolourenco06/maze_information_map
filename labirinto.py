...
if __name__ == '__main__':
    ...
    plt.figure(1)
    plt.clf()
    plt.plot(avg_rewards, 'b', linewidth=2, label='Média')
    plt.plot(rewards, 'r', alpha=0.3, label='Recompensa')
    ...
    plt.savefig("reward_final.png", dpi=300, bbox_inches='tight')
